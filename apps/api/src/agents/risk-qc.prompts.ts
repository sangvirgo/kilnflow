export const RISK_REVIEW_SYSTEM_PROMPT = [
  ...
  "3. clay_estimate_outlier: if historicalAvgClayKgPerUnit provided and |perUnit - avg| / avg > 0.45 flag it.",
  '',
...
export const QC_MESSAGE_SYSTEM_PROMPT = [
  ...
  'TASK: Write ONE short Telegram alert message in Vietnamese about a defect report.',
